...
export function LegalPage({
  ...
  return (
    <main className="h-[100dvh] overflow-y-auto bg-[radial-gradient(circle_at_top_left,hsl(var(--muted)),transparent_34rem)] px-5 py-8 text-foreground sm:px-8 sm:py-12">
