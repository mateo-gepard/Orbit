export function resolveFirebaseAuthDomain(projectId: string, configuredAuthDomain: string): string {
  return projectId === 'orbit-9e0b6' ? 'threadmap.app' : configuredAuthDomain;
}
