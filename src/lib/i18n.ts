...
const en = {
  ...
  'settings.exportAllDataDesc': 'Download all tasks, habits, events, goals, projects, notes and settings as a JSON file',
...
const de: Record<TranslationKey, string> = {
  ...
  'settings.exportAllData': 'Alle Daten exportieren',
  'settings.exportAllDataDesc': 'Alle Aufgaben, Gewohnheiten, Termine, Ziele, Projekte, Notizen und Einstellungen als JSON-Datei herunterladen',
