    ...
    <div className="p-4 lg:p-8 space-y-5 max-w-3xl mx-auto">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-lg border border-border/50 bg-transparent py-2 pl-9 pr-3 text-[13px] outline-none placeholder:text-muted-foreground/30 focus:border-foreground/20 transition-colors"
        />
      </div>
        ...
        {archivedItems.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-foreground/[0.04]">
              <ArchiveIcon className="h-5 w-5 text-muted-foreground/30" />
            </div>
